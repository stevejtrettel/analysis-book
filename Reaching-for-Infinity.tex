...
\subsection{GE: Integration Discovers the
Logarithm}\label{ge-integration-discovers-the-logarithm}
...
\subsection{GE: The Weierstrass Product for
Sine}\label{ge-the-weierstrass-product-for-sine}
...
\section{Calculating π}\label{calculating-ux3c0}
...
\subsection{GE: Stirling's
Approximation}\label{ge-stirlings-approximation}
